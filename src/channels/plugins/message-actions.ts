...
export function listChannelMessageActions(cfg: EspadaConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: EspadaConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: EspadaConfig): boolean {
  for (const plugin of listChannelPlugins()) {
