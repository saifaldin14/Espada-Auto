...
export type ChannelAgentToolFactory = (params: { cfg?: EspadaConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: EspadaConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: EspadaConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: EspadaConfig }) => boolean;
  supportsCards?: (params: { cfg: EspadaConfig }) => boolean;
