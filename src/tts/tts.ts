...
export function resolveTtsConfig(cfg: EspadaConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.ESPADA_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: EspadaConfig): string | undefined {
