...
import { type EspadaConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: EspadaConfig): string[] {
...
export function listAgentsForGateway(cfg: EspadaConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: EspadaConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: EspadaConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: EspadaConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: EspadaConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: EspadaConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: EspadaConfig): GatewaySessionsDefaults {
