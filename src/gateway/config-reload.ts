...
import type { EspadaConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: EspadaConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: EspadaConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: EspadaConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: EspadaConfig) => void;
  log: {
