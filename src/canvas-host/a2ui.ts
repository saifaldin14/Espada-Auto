...
export const A2UI_PATH = "/__espada__/a2ui";
export const CANVAS_HOST_PATH = "/__espada__/canvas";
export const CANVAS_WS_PATH = "/__espada/ws";
...
(() => {
  ...
  const handlerNames = ["espadaCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.Espada = globalThis.Espada ?? {};
  globalThis.Espada.postMessage = postToNode;
  globalThis.Espada.sendUserAction = sendUserAction;
  globalThis.espadaPostMessage = postToNode;
  globalThis.espadaSendUserAction = sendUserAction;
  globalThis.espadaPostMessage = postToNode;
  globalThis.espadaSendUserAction = sendUserAction;
