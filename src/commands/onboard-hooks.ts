...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.espada.dev/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("espada hooks list")}`,
      `  ${formatCliCommand("espada hooks enable <name>")}`,
      `  ${formatCliCommand("espada hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
