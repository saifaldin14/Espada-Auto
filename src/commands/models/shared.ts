...
export async function updateConfig(
  mutator: (cfg: EspadaConfig) => EspadaConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: EspadaConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: EspadaConfig): Set<string> {
