...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "espada-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<EspadaConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<EspadaConfig["telegram"]>>,
