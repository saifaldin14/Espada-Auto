...
export function applyZaiConfig(cfg: EspadaConfig): EspadaConfig {
...
export function applyOpenrouterProviderConfig(cfg: EspadaConfig): EspadaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: EspadaConfig): EspadaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: EspadaConfig): EspadaConfig {
...
export function applyOpenrouterConfig(cfg: EspadaConfig): EspadaConfig {
...
export function applyMoonshotProviderConfig(cfg: EspadaConfig): EspadaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: EspadaConfig): EspadaConfig {
...
export function applyKimiCodeProviderConfig(cfg: EspadaConfig): EspadaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: EspadaConfig): EspadaConfig {
...
export function applySyntheticProviderConfig(cfg: EspadaConfig): EspadaConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: EspadaConfig): EspadaConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: EspadaConfig): EspadaConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: EspadaConfig): EspadaConfig {
