...
describe("resolveGatewayProgramArguments", () => {
  it("uses realpath-resolved dist entry when running via npx shim", async () => {
    const argv1 = path.resolve("/tmp/.npm/_npx/63c3/node_modules/.bin/espada");
    const entryPath = path.resolve("/tmp/.npm/_npx/63c3/node_modules/espada/dist/entry.js");
  ...
  it("prefers symlinked path over realpath for stable service config", async () => {
    // Simulates pnpm global install where node_modules/espada is a symlink
    // to .pnpm/espada@X.Y.Z/node_modules/espada
    const symlinkPath = path.resolve(
      "/Users/test/Library/pnpm/global/5/node_modules/espada/dist/entry.js",
    );
    const realpathResolved = path.resolve(
      "/Users/test/Library/pnpm/global/5/node_modules/.pnpm/espada@2026.1.21-2/node_modules/espada/dist/entry.js",
    );
  ...
  it("falls back to node_modules package dist when .bin path is not resolved", async () => {
    const argv1 = path.resolve("/tmp/.npm/_npx/63c3/node_modules/.bin/espada");
    const indexPath = path.resolve("/tmp/.npm/_npx/63c3/node_modules/espada/dist/index.js");
    process.argv = ["node", argv1];
