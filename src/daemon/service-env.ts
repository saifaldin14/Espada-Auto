...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    ESPADA_PROFILE: profile,
    ESPADA_STATE_DIR: env.ESPADA_STATE_DIR,
    ESPADA_CONFIG_PATH: env.ESPADA_CONFIG_PATH,
    ESPADA_GATEWAY_PORT: String(port),
    ESPADA_GATEWAY_TOKEN: token,
    ESPADA_LAUNCHD_LABEL: resolvedLaunchdLabel,
    ESPADA_SYSTEMD_UNIT: systemdUnit,
    ESPADA_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    ESPADA_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    ESPADA_STATE_DIR: env.ESPADA_STATE_DIR,
    ESPADA_CONFIG_PATH: env.ESPADA_CONFIG_PATH,
    ESPADA_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    ESPADA_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    ESPADA_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    ESPADA_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    ESPADA_LOG_PREFIX: "node",
    ESPADA_SERVICE_MARKER: NODE_SERVICE_MARKER,
    ESPADA_SERVICE_KIND: NODE_SERVICE_KIND,
    ESPADA_SERVICE_VERSION: VERSION,
  };
}
