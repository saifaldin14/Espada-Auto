...
export function listBindings(cfg: EspadaConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: EspadaConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: EspadaConfig) {
