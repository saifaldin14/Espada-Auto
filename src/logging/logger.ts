...
export const DEFAULT_LOG_DIR = "/tmp/espada";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "espada.log"); // legacy single-file path

const LOG_PREFIX = "espada";
...
function resolveSettings(): ResolvedSettings {
  let cfg: EspadaConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => EspadaConfig;
      };
