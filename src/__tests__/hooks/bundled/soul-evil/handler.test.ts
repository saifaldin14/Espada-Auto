...
import handler from "../../../../hooks/bundled/soul-evil/handler.js";
import { createHookEvent } from "../../../../hooks/hooks.js";
import type { AgentBootstrapHookContext } from "../../../../hooks/hooks.js";
import type { EspadaConfig } from "../../../../config/config.js";
import { makeTempWorkspace, writeWorkspaceFile } from "../../../../test-helpers/workspace.js";

describe("soul-evil hook", () => {
  it("skips subagent sessions", async () => {
    const tempDir = await makeTempWorkspace("espada-soul-");
