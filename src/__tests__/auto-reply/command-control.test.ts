...
import { hasControlCommand, hasInlineCommandTokens } from "../../auto-reply/command-detection.js";
...
import { parseSendPolicyCommand } from "../../auto-reply/send-policy.js";
...
describe("control command parsing", () => {
  ...
  it("ignores telegram commands addressed to other bots", () => {
    ...
    expect(
      hasControlCommand("/help@espada", undefined, {
        botUsername: "espada",
      }),
    ).toBe(true);
  });
