...
import { listSkillCommandsForAgents, resolveSkillCommandInvocation } from "../../auto-reply/skill-commands.js";
...
describe("listSkillCommandsForAgents", () => {
  it("merges command names across agents and de-duplicates", async () => {
    const baseDir = await fs.mkdtemp(path.join(os.tmpdir(), "espada-skills-"));
