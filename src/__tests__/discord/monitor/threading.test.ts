...
} from "../../../discord/monitor/threading.js";
  ...
  it("switches delivery + session context to the created thread", async () => {
    ...
    const plan = await resolveDiscordAutoThreadReplyPlan({
      ...
      message: {
        id: "m1",
        channelId: "parent",
      } as unknown as import("../../../discord/monitor/listeners.js").DiscordMessageEvent["message"],
      isGuildMessage: true,
      channelConfig: {
        autoThread: true,
      } as unknown as import("../../../discord/monitor/allow-list.js").DiscordChannelConfigResolved,
      threadChannel: null,
      baseText: "hello",
      combinedBody: "hello",
      replyToMode: "all",
