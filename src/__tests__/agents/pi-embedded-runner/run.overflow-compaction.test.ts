...
vi.mock("../../../agents/models-config.js", () => ({
  ensureEspadaModelsJson: vi.fn(async () => {}),
}));
...
vi.mock("../../../agents/agent-paths.js", () => ({
  resolveEspadaAgentDir: vi.fn(() => "/tmp/agent-dir"),
}));
...
vi.mock("../../../agents/pi-embedded-runner/logger.js", () => ({
  log: {
    debug: vi.fn(),
    info: vi.fn(),
    warn: vi.fn(),
...
vi.mock("../../../agents/pi-embedded-runner/run/payloads.js", () => ({
  buildEmbeddedRunPayloads: vi.fn(() => []),
}));

vi.mock("../../../agents/pi-embedded-runner/utils.js", () => ({
...
import { runEmbeddedAttempt } from "../../../agents/pi-embedded-runner/run/attempt.js";
