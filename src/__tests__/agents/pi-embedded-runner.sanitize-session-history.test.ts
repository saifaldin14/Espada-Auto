...
import * as helpers from "../../agents/pi-embedded-helpers.js";

type SanitizeSessionHistory =
  typeof import("../../agents/pi-embedded-runner/google.js").sanitizeSessionHistory;
...
describe("sanitizeSessionHistory", () => {
  ...
  beforeEach(async () => {
    ...
    vi.resetModules();
    ({ sanitizeSessionHistory } = await import("../../agents/pi-embedded-runner/google.js"));
  });
