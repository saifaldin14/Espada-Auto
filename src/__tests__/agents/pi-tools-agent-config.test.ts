...
import type { SandboxDockerConfig } from "../../agents/sandbox.js";
...
describe("Agent-specific tool filtering", () => {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createEspadaCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createEspadaCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createEspadaCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createEspadaCodingTools({
      config: cfg,
    ...
    const bobTools = createEspadaCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createEspadaCodingTools({
      config: cfg,
