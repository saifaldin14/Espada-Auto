...
describe("subagent registry persistence", () => {
  ...
  it("persists runs to disk and resumes after restart", async () => {
    tempStateDir = await fs.mkdtemp(path.join(os.tmpdir(), "espada-subagent-"));
    process.env.ESPADA_STATE_DIR = tempStateDir;

    vi.resetModules();
    const mod1 = await import("../../agents/subagent-registry.js");
    ...
    vi.resetModules();
    const mod2 = await import("../../agents/subagent-registry.js");
  ...
  it("skips cleanup when cleanupHandled was persisted", async () => {
    ...
    vi.resetModules();
    const mod = await import("../../agents/subagent-registry.js");
