...
import { expandToolGroups, resolveToolProfilePolicy, TOOL_GROUPS } from "../../agents/tool-policy.js";
...
describe("tool-policy", () => {
  ...
  it("includes core tool groups in group:espada", () => {
    const group = TOOL_GROUPS["group:espada"];
