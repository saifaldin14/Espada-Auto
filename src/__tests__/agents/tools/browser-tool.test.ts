...
vi.mock("../../../agents/tools/nodes-utils.js", async () => {
  const actual = await vi.importActual<typeof import("../../../agents/tools/nodes-utils.js")>("./nodes-utils.js");
  return {
    ...actual,
...
vi.mock("../../../agents/tools/gateway.js", () => gatewayMocks);
...
vi.mock("../../../agents/tools/common.js", async () => {
  const actual = await vi.importActual<typeof import("../../../agents/tools/common.js")>("./common.js");
  return {
    ...actual,
