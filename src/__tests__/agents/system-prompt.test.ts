...
import { buildAgentSystemPrompt, buildRuntimeLine } from "../../agents/system-prompt.js";
...
describe("buildAgentSystemPrompt", () => {
  ...
  it("includes a CLI quick reference section", () => {
    ...
    expect(prompt).toContain("## Espada CLI Quick Reference");
    expect(prompt).toContain("espada gateway restart");
  ...
  it("preserves tool casing in the prompt", () => {
    ...
    expect(prompt).toContain("Espada docs: /tmp/espada/docs");
    expect(prompt).toContain(
  ...
  it("adds ClaudeBot self-update guidance when gateway tool is available", () => {
    ...
    expect(prompt).toContain("## Espada Self-Update");
