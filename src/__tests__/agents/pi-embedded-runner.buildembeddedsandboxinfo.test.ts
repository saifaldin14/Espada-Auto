...
const _ensureModels = (cfg: EspadaConfig, agentDir: string) =>
  ensureEspadaModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/espada-sandbox",
      agentWorkspaceDir: "/tmp/espada-workspace",
      ...
      browser: {
        ...
        containerName: "espada-sbx-browser-test",
      },
