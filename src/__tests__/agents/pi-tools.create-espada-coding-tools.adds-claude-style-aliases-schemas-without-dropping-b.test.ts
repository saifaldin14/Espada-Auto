...
describe("createEspadaCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createEspadaCodingTools({
      config,
    ...
    const anthropicTools = createEspadaCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createEspadaCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createEspadaCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
