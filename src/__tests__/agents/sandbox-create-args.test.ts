...
import { buildSandboxCreateArgs, type SandboxDockerConfig } from "../../agents/sandbox.js";
  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "espada.sandbox=1",
        "--label",
        "espada.sessionKey=main",
        "--label",
        "espada.createdAtMs=1700000000000",
        "--label",
        "espada.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
