...
import { isBotMentionedFromTargets, resolveMentionTargets } from "../../../web/auto-reply/mentions.js";
...
describe("isBotMentionedFromTargets", () => {
  const mentionCfg = { mentionRegexes: [/\bespada\b/i] };

  it("ignores regex matches when other mentions are present", () => {
    const msg = makeMsg({
      body: "@Espada please help",
