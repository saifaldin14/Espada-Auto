...
const HOME = path.join(realOs.tmpdir(), "espada-home-header-ext-test");
...
vi.mock("../../media/mime.js", async () => {
  const actual = await vi.importActual<typeof import("../../media/mime.js")>("./mime.js");
  return {
    ...actual,
...
const store = await import("../../media/store.js");
