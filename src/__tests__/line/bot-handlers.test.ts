...
vi.mock("../../line/bot-message-context.js", () => ({
...
let handleLineWebhookEvents: typeof import("../../line/bot-handlers.js").handleLineWebhookEvents;
...
describe("handleLineWebhookEvents", () => {
  beforeAll(async () => {
    ({ handleLineWebhookEvents } = await import("../../line/bot-handlers.js"));
  });
