...
const resolveStateDir = vi.fn().mockReturnValue("/tmp/espada-state");
...
describe("github-copilot token", () => {
  beforeEach(() => {
    ...
    resolveStateDir.mockReturnValue("/tmp/espada-state");
  });

  it("derives baseUrl from token", async () => {
    const { deriveCopilotApiBaseUrlFromToken } = await import("../../providers/github-copilot-token.js");
