...
vi.mock("../../cli/gateway-rpc.js", async () => {
  const actual = await vi.importActual<typeof import("../../cli/gateway-rpc.js")>("./gateway-rpc.js");
  return {
    ...actual,
...
describe("logs cli", () => {
  ...
  it("writes output directly to stdout/stderr", async () => {
    ...
    const { registerLogsCli } = await import("../../cli/logs-cli.js");
