...
vi.mock("../../cli/nodes-cli/rpc.js", async () => {
  const actual = await vi.importActual<typeof import("../../cli/nodes-cli/rpc.js")>("./nodes-cli/rpc.js");
  return {
    ...actual,
...
describe("exec approvals CLI", () => {
  it("loads local approvals by default", async () => {
    ...
    const { registerExecApprovalsCli } = await import("../../cli/exec-approvals-cli.js");
