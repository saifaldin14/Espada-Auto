...
describe("OpenResponses Feature Parity", () => {
  describe("Schema Validation", () => {
    it("should validate input_image with url source", async () => {
      const { InputImageContentPartSchema } = await import("../../gateway/open-responses.schema.js");
    ...
    it("should validate input_file with url source", async () => {
      const { InputFileContentPartSchema } = await import("../../gateway/open-responses.schema.js");
    ...
    it("should validate tool definition", async () => {
      const { ToolDefinitionSchema } = await import("../../gateway/open-responses.schema.js");
  ...
  describe("CreateResponseBody Schema", () => {
    it("should validate request with input_image", async () => {
      const { CreateResponseBodySchema } = await import("../../gateway/open-responses.schema.js");
  ...
  describe("Response Resource Schema", () => {
    it("should validate response with function_call output", async () => {
      const { OutputItemSchema } = await import("../../gateway/open-responses.schema.js");
  ...
  describe("buildAgentPrompt", () => {
    it("should convert function_call_output to tool entry", async () => {
      const { buildAgentPrompt } = await import("../../gateway/openresponses-http.js");
