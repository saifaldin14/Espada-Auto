...
} from "../../../gateway/secrets-accessor.js";

import { ConfigFileDriftScanner, EnvVarDriftScanner } from "../../../gateway/drift/builtin-scanners.js";

import { LocalMeshAdapter } from "../../../gateway/mesh/local-adapter.js";
...
import { validateEnterpriseConfig } from "../../../gateway/enterprise/validate-config.js";
...
describe("Admin RBAC gate", () => {
  ...
  beforeEach(async () => {
    const { authorizeGatewayConnect, authorizeGatewayPermission } = await import("../../../gateway/auth.js");
  ...
  it("returns 401 when auth fails", async () => {
    const { authorizeGatewayConnect } = await import("../../../gateway/auth.js");
...
import { buildOpenApiSpec, buildRouteSummary, ADMIN_ROUTES } from "../../../gateway/enterprise/admin-openapi.js";
