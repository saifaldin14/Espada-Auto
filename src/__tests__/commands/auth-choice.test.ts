...
import { applyAuthChoice, resolvePreferredProviderForAuthChoice } from "../../commands/auth-choice.js";
...
describe("applyAuthChoice", () => {
  ...
  it("prompts and writes MiniMax API key when selecting minimax-api", async () => {
    tempStateDir = await fs.mkdtemp(path.join(os.tmpdir(), "espada-auth-"));
