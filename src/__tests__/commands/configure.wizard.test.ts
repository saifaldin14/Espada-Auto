...
vi.mock("../../config/config.js", () => ({
  CONFIG_PATH: "~/.espada/espada.json",
...
vi.mock("../../commands/onboard-helpers.js", () => ({
  DEFAULT_WORKSPACE: "~/.espada/workspace",
  applyWizardMetadata: (cfg: EspadaConfig) => cfg,
...
vi.mock("../../commands/configure.gateway.js", () => ({
  promptGatewayConfig: vi.fn(),
}));

vi.mock("../../commands/configure.gateway-auth.js", () => ({
  promptAuthConfig: vi.fn(),
}));

vi.mock("../../commands/configure.channels.js", () => ({
  removeChannelConfigWizard: vi.fn(),
}));

vi.mock("../../commands/configure.daemon.js", () => ({
