...
function resolveAvatarSource(cfg: EspadaConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: EspadaConfig, agentId: string): AgentAvatarResolution {
