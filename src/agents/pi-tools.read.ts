...
// NOTE: Upstream read now does file-magic MIME detection; we keep the wrapper
...
export function createSandboxedReadTool(root: string) {
  ...
  return wrapSandboxPathGuard(createEspadaReadTool(base), root);
}
...
export function createEspadaReadTool(base: AnyAgentTool): AnyAgentTool {
