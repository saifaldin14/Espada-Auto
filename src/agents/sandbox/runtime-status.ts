...
function resolveMainSessionKeyForSandbox(params: { cfg?: EspadaConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: EspadaConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`espada sandbox explain --session ${runtime.sessionKey}`)}`,
  );
