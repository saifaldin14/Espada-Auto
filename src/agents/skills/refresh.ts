...
function resolveWatchPaths(workspaceDir: string, config?: EspadaConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: EspadaConfig }) {
