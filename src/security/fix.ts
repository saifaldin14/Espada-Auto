...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof EspadaConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: EspadaConfig; env: NodeJS.ProcessEnv }): {
  cfg: EspadaConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
