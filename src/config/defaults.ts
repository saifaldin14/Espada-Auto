...
function resolveAnthropicDefaultAuthMode(cfg: EspadaConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: EspadaConfig): EspadaConfig {
...
export function applyTalkApiKey(config: EspadaConfig): EspadaConfig {
...
export function applyModelDefaults(cfg: EspadaConfig): EspadaConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: EspadaConfig): EspadaConfig {
...
export function applyLoggingDefaults(cfg: EspadaConfig): EspadaConfig {
...
export function applyContextPruningDefaults(cfg: EspadaConfig): EspadaConfig {
...
export function applyCompactionDefaults(cfg: EspadaConfig): EspadaConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
