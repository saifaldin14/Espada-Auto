...
function resolveMentionPatterns(cfg: EspadaConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: EspadaConfig | undefined, agentId?: string): RegExp[] {
