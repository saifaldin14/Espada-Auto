...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@espada", { botUsername: "espada" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@espada args", {
        botUsername: "espada",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "espada" })).toBe(
      "/help@otherbot",
    );
  });
