...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @espada/voice-call -> voice-call).
...
function addCandidate(params: {
  ...
  params.candidates.push({
    ...
    packageEspada: getPackageManifestMetadata(manifest ?? undefined),
  });
}
...
export function discoverEspadaPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExt = path.join(workspaceRoot, ".espada", "extensions");
    discoverInDirectory({
      dir: workspaceExt,
      origin: "workspace",
