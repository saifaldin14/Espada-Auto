...
export const PLUGIN_MANIFEST_FILENAME = "espada.plugin.json";
...
// package.json "espada" metadata (used for onboarding/catalog)
...
export type EspadaPackageManifest = {
  extensions?: string[];
...
): EspadaPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.espada ?? manifest[LEGACY_MANIFEST_KEY];
}
