  ...
  const authHint = (() => {
      ...
      return html`
        <div class="muted" style="margin-top: 8px;">
          ...
          <div style="margin-top: 6px;">
            <span class="mono">espada dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">espada doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px;">
            <a
              class="session-link"
    ...
    return html`
      <div class="muted" style="margin-top: 8px;">
        ...
        <span class="mono">espada dashboard --no-open</span>, or update the token,
        then click Connect.
        <div style="margin-top: 6px;">
          <a
            class="session-link"
        ...
        <div class="form-grid" style="margin-top: 16px;">
          ...
          <label class="field">
            ...
            <input
              ...
              placeholder="ESPADA_GATEWAY_TOKEN"
            />
          </label>
          <label class="field">
