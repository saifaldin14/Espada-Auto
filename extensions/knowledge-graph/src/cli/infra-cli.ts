...
import { generateScanReport, type ReportFormat } from "../reporting/report.js";
import {
  InfraMonitor,
  SCHEDULE_PRESETS,
  BUILTIN_ALERT_RULES,
...
// import { findOrphans, findSinglePointsOfFailure } from "../core/queries.js";
...
export function registerInfraCli(ctx: InfraCliContext): void {
  ...
  infra
    ...
    .action(async (opts: {
      ...
      const alertDestinations: import("../monitoring/monitoring.js").AlertDestination[] = [
        { type: "console" },
      ];
      if (opts.webhook) {
