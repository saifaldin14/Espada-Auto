...
import { removeAckReactionAfterReply, shouldAckReaction } from "espada/plugin-sdk";
import type { EspadaConfig, PluginRuntime } from "espada/plugin-sdk";
import {
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/espada") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
