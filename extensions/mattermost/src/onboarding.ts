import type { ChannelOnboardingAdapter, EspadaConfig, WizardPrompter } from "espada/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.espada.dev/channels/mattermost",
    ].join("\n"),
