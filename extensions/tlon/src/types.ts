...
export function resolveTlonAccount(cfg: EspadaConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: EspadaConfig): string[] {
  const base = cfg.channels?.tlon as
