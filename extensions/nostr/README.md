...
Nostr DM channel plugin for Espada using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Espada. It enables your bot to:
...
# Configure espada to use local relay
