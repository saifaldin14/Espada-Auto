...
### Changes
- Version alignment with core Espada release numbers.
...
### Highlights
- First public release of the @espada/voice-call plugin.
...
- CLI: `espada voicecall` commands (call/start/continue/speak/end/status/tail/expose).
