...
# Defaults target the Espada assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/Espada/Resources/Espada.icns"}
