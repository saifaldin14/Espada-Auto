...
# Output:
# - dist/Espada.app
# - dist/Espada-<version>.zip
# - dist/Espada-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Espada-$VERSION.zip"
DMG="$ROOT_DIR/dist/Espada-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Espada-$VERSION.notary.zip"
