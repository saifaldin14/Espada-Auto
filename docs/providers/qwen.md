---
summary: "Use Qwen OAuth (free tier) in Espada"
read_when:
  - You want to use Qwen with Espada
...
```bash
espada models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Espada will sync credentials
