...
You can point Espada at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Espada
...
- [Anthropic provider](/providers/anthropic) - Native Espada integration with Claude setup-token or API keys
