---
summary: "Use MiniMax M2.1 in Espada"
read_when:
  - You want MiniMax models in Espada
...
Configure manually via `espada.json`:
...
- Use `espada models list` and `espada models set minimax/MiniMax-M2.1` to switch.
...
- Running `espada configure` and selecting **MiniMax M2.1**, or
