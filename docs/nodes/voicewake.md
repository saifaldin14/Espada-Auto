...
Espada treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.espada/settings/voicewake.json`

Shape:

```json
{ "triggers": ["espada", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
