---
summary: "Backstory and lore of Espada for context and tone"
read_when:
...
Shedding its old shell, the creature emerged anew as **Molty**, living in a **Espada**. New shell, same lobster soul.
...
The **Moltiverse** is the community and ecosystem around Espada. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with espada."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @espada. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Espada" to promote pump-and-dump tokens.
