...
Espada ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Espada also aligns
the install method:
...
When you switch channels with `espada update`, Espada also syncs plugin sources:
