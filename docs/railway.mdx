...
Deploy Espada on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/espada-railway-template" target="_blank" rel="noreferrer">Deploy on Railway</a>
...
- `https://<your-railway-domain>/espada` — Control UI

## What you get

- Hosted Espada Gateway + Control UI
...
- `ESPADA_STATE_DIR=/data/.espada` (recommended)
- `ESPADA_WORKSPACE_DIR=/data/workspace` (recommended)
- `ESPADA_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Espada state + workspace so you can migrate to another host without losing config or memory.
