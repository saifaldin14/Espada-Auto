...
This page ties together how Espada handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Espada keeps a
...
Espada separates the **prompt body** from the **command body**:
...
Espada can expose or hide model reasoning:
