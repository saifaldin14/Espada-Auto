...
read_when:
  - You want to understand what “context” means in Espada
  - You are debugging why the model “knows” something (or forgot it)
  - You want to reduce context overhead (/context, /status, /compact)
---
# Context

“Context” is **everything Espada sends to the model for a run**. It is bounded by the model’s **context window** (token limit).

Beginner mental model:
- **System prompt** (Espada-built): rules, tools, skills list, time/runtime, and injected workspace files.
...
## How Espada builds the system prompt

The system prompt is **Espada-owned** and rebuilt each run. It includes:
...
By default, Espada injects a fixed set of workspace files (if present):
- `AGENTS.md`
- `SOUL.md`
- `TOOLS.md`
- `IDENTITY.md`
