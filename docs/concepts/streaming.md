...
Espada has two separate “streaming” layers:
...
When block streaming is enabled, Espada can **merge consecutive block chunks**
...
When draft streaming is active, Espada disables block streaming for that reply to avoid double-streaming.
