...
Espada. All clients (CLI, web UI, macOS app, iOS/Android nodes, headless
...
- If `ESPADA_GATEWAY_TOKEN` (or `--token`) is set, `connect.params.auth.token`
