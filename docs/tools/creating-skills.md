...
Espada is designed to be easily extensible. "Skills" are the primary way to add new capabilities to your assistant.
...
### 4. Refresh Espada
Ask your agent to "refresh skills" or restart the gateway. Espada will discover the new directory and index the `SKILL.md`.
