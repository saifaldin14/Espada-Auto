---
summary: "Frequently asked questions about Espada setup, configuration, and usage"
---
# FAQ
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up Espada?](#whats-the-recommended-way-to-install-and-set-up-espada)
  ...
  - [I can't access docs.espada.dev (SSL error). What now?](#i-cant-access-docsespada-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or espada not recognized](#windows-install-says-git-not-found-or-espada-not-recognized)
  ...
  - [If I buy a Mac mini to run Espada, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-espada-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Espadas?](#can-multiple-people-use-one-whatsapp-number-with-different-espadas)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Espada on a dedicated machine?](#how-important-is-it-to-run-espada-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Espada in a VM and what are the requirements](#can-i-run-espada-in-a-vm-and-what-are-the-requirements)
- [What is Espada?](#what-is-espada)
  - [What is Espada, in one paragraph?](#what-is-espada-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Espada](#what-are-the-top-five-everyday-use-cases-for-espada)
  - [Can Espada help with lead gen outreach ads and blogs for a SaaS](#can-espada-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Espada run tasks on a schedule or continuously in the background?](#can-espada-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Espada saved locally?](#is-all-data-used-with-espada-saved-locally)
  - [Where does Espada store its data?](#where-does-espada-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Espada?](#how-do-i-completely-uninstall-espada)
...
- [Config basics](#config-basics)
  ...
  - [Can the Espada browser run headless?](#can-the-espada-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two Espadas talk to each other (local + VPS)?](#can-two-espadas-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Espada load environment variables?](#how-does-espada-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of Espadas one CEO and many agents](#is-there-a-way-to-make-a-team-of-espadas-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Espada but keep it installed?](#how-do-i-completely-reset-espada-but-keep-it-installed)
  ...
  - [Why doesn’t Espada reply in a group?](#why-doesnt-espada-reply-in-a-group)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `espada gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-espada-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `espada gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-espada-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Espada in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-espada-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Espada?](#i-closed-my-terminal-on-windows-how-do-i-restart-espada)
  ...
  - [ELI5: `espada gateway restart` vs `espada gateway`](#eli5-espada-gateway-restart-vs-espada-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Espada to inbound DMs?](#is-it-safe-to-expose-espada-to-inbound-dms)
...
5) **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/espada/espada-*.log | head -1)"
   ```
...
7) **Gateway snapshot**
   ```bash
   espada health --json
   espada health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://espada.dev/install.sh | bash -s -- --install-method git
```

This installs Espada **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/espada/espada/issues
https://github.com/espada/espada/pulls

Start with these commands (share outputs when asking for help):

```bash
espada status
espada models status
espada doctor
```

What they do:
- `espada status`: quick snapshot of gateway/agent health + basic config.
- `espada models status`: checks provider auth + model availability.
- `espada doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `espada status --all`, `espada logs --follow`,
`espada gateway status`, `espada health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### Whats the recommended way to install and set up Espada
...
```bash
git clone https://github.com/espada/espada.git
cd espada
pnpm install
pnpm build
...
If you don’t have a global install yet, run it via `pnpm espada onboard`.
...
- If it asks for auth, run `espada dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `ESPADA_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**
- **Tailscale Serve** (recommended): keep bind loopback, run `espada gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `espada gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `espada dashboard`.
...
under `~/.espada/` (for example `~/.espada/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-espada-store-its-data),
...
https://github.com/espada/espada/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docsespada SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.espada.dev` via Xfinity
Advanced Security. Disable it or allowlist `docs.espada.dev`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsespada-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/espada/espada/tree/main/docs
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://espada.dev/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://espada.dev/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
https://espada.dev/install.ps1
...
```bash
curl -fsSL https://espada.dev/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://espada.dev/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://espada.dev/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or espada not recognized
...
**2) espada is not recognized after install**
...
### How do I install Espada on Linux
...
### How do I install Espada on a VPS
...
```bash
espada update
espada update status
espada update --channel stable|beta|dev
espada update --tag <dist-tag|version>
espada update --no-restart
```

If you must automate from an agent:

```bash
espada update --yes --no-restart
espada gateway restart
```
...
`espada onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Espada with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `espada models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `espada models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `espada models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. Espada no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Espada can keep replying while a provider is rate‑limited.
...
Espada supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Espada fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `espada.json`.

Steps:
1) Enable the plugin: `espada plugins enable google-gemini-cli-auth`
2) Login: `espada models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Espada needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Espada runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. Espada’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run Espada can I connect it to my MacBook Pro
...
- Use `espada nodes status` / `espada nodes list` to see it.
...
- DM your bot, then run `espada logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Espadas
...
If you run Espada via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
**Espada-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Espada on a dedicated machine
...
Espada is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Espada in a VM and what are the requirements
...
### What is Espada in one paragraph

Espada is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### Whats the value proposition

Espada is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Espada
...
### Can Espada help with lead gen outreach ads and blogs for a SaaS
...
Espada draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Espada is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Espada when you
...
Showcase: https://espada.dev/showcase

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.espada/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.espada/espada.json`). Precedence is `<workspace>/skills` > `~/.espada/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.
...
Checklist:
- Confirm cron is enabled (`cron.enabled`) and `ESPADA_SKIP_CRON` is not set.
- Check the Gateway is running 24/7 (no sleep/restarts).
- Verify timezone settings for the job (`--tz` vs host timezone).

Debug:
```bash
espada cron run <jobId> --force
espada cron runs --id <jobId> --limit 50
```
...
Not directly. macOS skills are gated by `metadata.espada.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-espada-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Espada can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3) Override the skill metadata (workspace or `~/.espada/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: {"espada":{"os":["darwin","linux"],"requires":{"bins":["imsg"]}}}
   ---
   ```
4) Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (Espada only needs stdio). See [iMessage](/channels/imessage).
...
Espada memory is just Markdown files in the agent workspace:
- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Espada also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, Espada auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Espada
prefers `local`.
...
### Is all data used with Espada saved locally

No - **Espada’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.espada` + your workspace directory).
...
### Where does Espada store its data

Everything lives under `$ESPADA_STATE_DIR` (default: `~/.espada`):

| Path | Purpose |
|------|---------|
| `$ESPADA_STATE_DIR/espada.json` | Main config (JSON5) |
| `$ESPADA_STATE_DIR/credentials/oauth.json` | Legacy OAuth import (copied into auth profiles on first use) |
| `$ESPADA_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys) |
| `$ESPADA_STATE_DIR/agents/<agentId>/agent/auth.json` | Runtime auth cache (managed automatically) |
| `$ESPADA_STATE_DIR/credentials/` | Provider state (e.g. `whatsapp/<accountId>/creds.json`) |
| `$ESPADA_STATE_DIR/agents/` | Per‑agent state (agentDir + sessions) |
| `$ESPADA_STATE_DIR/agents/<agentId>/sessions/` | Conversation history & state (per agent) |
| `$ESPADA_STATE_DIR/agents/<agentId>/sessions/sessions.json` | Session metadata (per agent) |
...
These files live in the **agent workspace**, not `~/.espada`.
...
Do **not** commit anything under `~/.espada` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Espada
...
`workspace` to the repo root. The Espada repo is just source code; keep the
...
Espada reads an optional **JSON5** config from `$ESPADA_CONFIG_PATH` (default: `~/.espada/espada.json`):
...
Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `ESPADA_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `espada doctor --generate-gateway-token`.
...
key. **Recommended:** run `espada configure --section web` to store it in
...
- Daemons read env vars from `~/.espada/.env` (or the service environment).
...
### Can the Espada browser run headless
...
5) Approve the node on the Gateway:
   ```bash
   espada nodes pending
   espada nodes approve <requestId>
   ```
...
Check the basics:
- Gateway is running: `espada gateway status`
- Gateway health: `espada status`
- Channel health: `espada channels status`
...
### Can two Espadas talk to each other local VPS
...
`espada agent --message ... --deliver`, targeting a chat where the other bot
listens. If one bot is on a remote VPS, point your CLI at that remote Gateway
via SSH/Tailscale (see [Remote access](/gateway/remote)).

Example pattern (run from a machine that can reach the target Gateway):
```bash
espada agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
Recover:
- Restore from backup (git or a copied `~/.espada/espada.json`).
- If you have no backup, re-run `espada doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:
- Use `espada config set` for small changes.
- Use `espada configure` for interactive edits.
...
```bash
espada gateway --tailscale serve
```
...
### How does Espada load environment variables

Espada reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.espada/.env` (aka `$ESPADA_STATE_DIR/.env`)
...
1) Put the missing keys in `~/.espada/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`ESPADA_LOAD_SHELL_ENV=1`, `ESPADA_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`espada models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means Espada won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1) Put the token in `~/.espada/.env`:
   ```
...
### Is there a way to make a team of Espadas one CEO and many agents
...
### How do I completely reset Espada but keep it installed
...
```bash
espada reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `ESPADA_PROFILE`), reset each state dir (defaults are `~/.espada-<profile>`).
- Dev reset: `espada gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Espada skips the heartbeat run to save API calls.
...
No. Espada runs on **your own account**, so if you’re in the group, Espada can see it.
...
```bash
espada directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt Espada reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.espada/agents/<agentId>/sessions/`.
...
- Use `espada doctor` to spot stray workspaces and profile mismatches.
...
Espada’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, Espada currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `espada models set ...` (updates just model config)
- `espada configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.espada/espada.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `espada doctor` to repair.
...
Yes. Espada ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.espada/agents/<agentId>/agent/auth-profiles.json
```

Fix options:
- Run `espada agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Espada can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.espada/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.espada/agent/*` (migrated by `espada doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.espada/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `espada models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `espada models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `espada models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.espada/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    espada models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Espada will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: Espada now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Espada uses provider‑prefixed IDs like:
...
Espada may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `espada models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
espada models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
espada models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
espada models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
espada models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

Espada supports both:
...
```
--port > ESPADA_GATEWAY_PORT > gateway.port > default 18789
```

### Why does espada gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `espada gateway status` and trust these lines:
- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does espada gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `ESPADA_STATE_DIR` mismatch).

Fix:
```bash
espada gateway install --force
```
Run that from the same `--profile` / environment you want the service to use.

### What does another gateway instance is already listening mean

Espada enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `espada gateway --port <port>`.

### How do I run Espada in remote mode client connects to a Gateway elsewhere
...
Notes:
- `espada gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
Facts (from code):
- The Control UI stores the token in browser localStorage key `espada.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:
- Fastest: `espada dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `espada doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `ESPADA_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `espada status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `ESPADA_CONFIG_PATH` (per‑instance config)
- `ESPADA_STATE_DIR` (per‑instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):
- Use `espada --profile <name> …` per instance (auto-creates `~/.espada-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `espada --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.espada.*`, `espada-gateway-<profile>.service`, `Espada Gateway (<profile>)`).
...
```
espada tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/espada/espada-YYYY-MM-DD.log
```
...
- macOS: `$ESPADA_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.espada/logs/...`; profiles use `~/.espada-<profile>/logs/...`)
- Linux: `journalctl --user -u espada-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Espada Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `espada gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Espada
...
1) Is the Gateway running? `espada gateway status`
2) Is the Gateway healthy? `espada status`
3) Does the UI have the right token? `espada dashboard`
...
```bash
espada channels status
espada channels logs --channel telegram
```
...
### ELI5 espada gateway restart vs espada gateway

- `espada gateway restart`: restarts the **background service** (launchd/systemd).
- `espada gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `espada gateway` when
...
```bash
espada message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Espada to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `espada pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `espada pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `espada doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Espada only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
espada pairing approve whatsapp <code>
```

List pending requests:

```bash
espada pairing list whatsapp
```
...
Espada blocks **cross‑provider** messaging by default. If a tool call is bound
