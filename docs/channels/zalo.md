...
- Install via CLI: `espada plugins install @espada/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `espada plugins install ./extensions/zalo`
   - From npm (if published): `espada plugins install @espada/zalo`
...
- Approve via:
  - `espada pairing list zalo`
  - `espada pairing approve zalo <CODE>`
...
- Example: `espada message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `espada channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `espada logs --follow`
