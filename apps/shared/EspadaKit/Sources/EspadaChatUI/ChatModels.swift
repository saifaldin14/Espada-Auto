...
public typealias EspadaPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias EspadaPlatformImage = UIImage
#endif

public struct EspadaChatUsageCost: Codable, Hashable, Sendable {
...
public struct EspadaChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: EspadaChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(EspadaChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct EspadaChatMessageContent: Codable, Hashable, Sendable {
...
public struct EspadaChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [EspadaChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: EspadaChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [EspadaChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: EspadaChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(EspadaChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([EspadaChatMessageContent].self, forKey: .content) {
...
public struct EspadaChatHistoryPayload: Codable, Sendable {
...
public struct EspadaSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct EspadaSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [EspadaSessionPreviewItem]
}

public struct EspadaSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [EspadaSessionPreviewEntry]

    public init(ts: Int, previews: [EspadaSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct EspadaChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct EspadaChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct EspadaAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct EspadaChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct EspadaGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct EspadaPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: EspadaPlatformImage?
...
public struct EspadaChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
