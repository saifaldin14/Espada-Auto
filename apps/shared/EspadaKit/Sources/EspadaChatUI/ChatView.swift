...
@MainActor
public struct EspadaChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    private var visibleMessages: [EspadaChatMessage] {
        let base: [EspadaChatMessage]
    ...
    private func mergeToolResults(in messages: [EspadaChatMessage]) -> [EspadaChatMessage] {
    ...
    private func isToolResultMessage(_ message: EspadaChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: EspadaChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: EspadaChatMessage) -> String {
