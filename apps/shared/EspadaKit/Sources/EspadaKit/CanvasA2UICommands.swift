...
public enum EspadaCanvasA2UICommand: String, Codable, Sendable {
...
public struct EspadaCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct EspadaCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
