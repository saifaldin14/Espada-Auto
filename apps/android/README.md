## Espada Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_espada-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm espada gateway --port 18789 --verbose
```
