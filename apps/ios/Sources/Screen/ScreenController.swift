...
final class ScreenController {
    ...
    /// Callback invoked when a espada:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = EspadaKitResources.bundle
...
/// Handles navigation policy to intercept espada:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept espada:// deep links
        if url.scheme == "espada" {
