...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: EspadaLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: EspadaLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: EspadaLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
