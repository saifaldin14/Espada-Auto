...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = EspadaLocationMode.off.rawValue
        ...
        NavigationStack {
            Form {
                ...
                Section("Screen") {
                    ...
                    Text("Keeps the screen awake while Espada is open.")
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                }
            }
    ...
    private var locationMode: EspadaLocationMode {
        EspadaLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
