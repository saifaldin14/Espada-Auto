...
final class AppState {
    ...
    var onboardingSeen: Bool {
        didSet { self.ifNotPreview { UserDefaults.standard.set(self.onboardingSeen, forKey: "espada.onboardingSeen") }
        }
    }

    var debugPaneEnabled: Bool {
        didSet {
            self.ifNotPreview { UserDefaults.standard.set(self.debugPaneEnabled, forKey: "espada.debugPaneEnabled") }
    ...
    init(preview: Bool = false) {
        ...
        let onboardingSeen = UserDefaults.standard.bool(forKey: "espada.onboardingSeen")
        self.isPaused = UserDefaults.standard.bool(forKey: pauseDefaultsKey)
        self.launchAtLogin = false
        self.onboardingSeen = onboardingSeen
        self.debugPaneEnabled = UserDefaults.standard.bool(forKey: "espada.debugPaneEnabled")
        ...
        let configRoot = EspadaConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = EspadaConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = EspadaConfigFile.loadDict()
            ...
            EspadaConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/espada"
        state.remoteCliPath = ""
        return state
    }
}
