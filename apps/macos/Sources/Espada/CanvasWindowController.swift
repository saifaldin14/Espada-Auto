...
final class CanvasWindowController: NSWindowController, WKNavigationDelegate, NSWindowDelegate {
    ...
    init(sessionKey: String, root: URL, presentation: CanvasPresentation) throws {
        ...
        (() => {
          try {
            ...
            if (globalThis.__espadaA2UIBridgeInstalled) return;
            globalThis.__espadaA2UIBridgeInstalled = true;
            ...
            globalThis.addEventListener('a2uiaction', (evt) => {
              try {
                ...
                const handler = globalThis.webkit?.messageHandlers?.espadaCanvasA2UIAction;
                ...
                const hasBundledA2UIHost = !!globalThis.espadaA2UI || !!document.querySelector('espada-a2ui-host');
                ...
                location.href = 'espada://agent?' + params.toString();
              } catch {}
            }, true);
          } catch {}
        })();
    ...
    func snapshot(to outPath: String?) async throws -> String {
        ...
        if let outPath, !outPath.isEmpty {
            ...
            path = "/tmp/espada-canvas-\(CanvasWindowController.sanitizeSessionKey(self.sessionKey))-\(ts).png"
        }
