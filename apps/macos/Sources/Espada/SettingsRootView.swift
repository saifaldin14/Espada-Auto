...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .espadaSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? EspadaPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? EspadaPaths.stateDirURL.path
...
extension Notification.Name {
    static let espadaSelectSettingsTab = Notification.Name("espadaSelectSettingsTab")
}
