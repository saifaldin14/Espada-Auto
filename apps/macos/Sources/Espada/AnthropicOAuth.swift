...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Espada token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: EspadaOAuthStore.AnthropicOAuthStatus = EspadaOAuthStore
...
enum EspadaOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let espadaOAuthDirEnv = "ESPADA_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Espada OAuth token file not found"
            case .unreadableFile: "Espada OAuth token file not readable"
            case .invalidJSON: "Espada OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Espada OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Espada OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.espadaOAuthDirEnv]?
