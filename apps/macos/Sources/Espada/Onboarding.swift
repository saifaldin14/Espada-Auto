...
enum UIStrings {
    static let welcomeTitle = "Welcome to Espada"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: EspadaOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: EspadaChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g espada@\(version)"
    }
