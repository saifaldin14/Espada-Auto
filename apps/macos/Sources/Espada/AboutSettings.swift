...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/espada/espada") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/espada/espada")
    ...
    private var buildTimestamp: String? {
        guard let raw = Bundle.main.object(forInfoDictionaryKey: "EspadaBuildTimestamp") as? String
        else { return nil }
    ...
    private var gitCommit: String {
        Bundle.main.object(forInfoDictionaryKey: "EspadaGitCommit") as? String ?? "unknown"
    }
