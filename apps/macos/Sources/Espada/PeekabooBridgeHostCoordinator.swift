...
final class PeekabooBridgeHostCoordinator {
    ...
    private var services: EspadaPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = EspadaPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: PeekabooBridgeConstants.espadaSocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(PeekabooBridgeConstants.espadaSocketPath, privacy: .public)")
    }
...
@MainActor
private final class EspadaPeekabooBridgeServices: PeekabooBridgeServiceProviding {
