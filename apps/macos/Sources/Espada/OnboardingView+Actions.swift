...
extension OnboardingView {
    ...
    func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .espadaSelectSettingsTab, object: tab)
        }
    }
    ...
    func finish() {
        UserDefaults.standard.set(true, forKey: "espada.onboardingSeen")
    ...
    func finishAnthropicOAuth() async {
        ...
        do {
            ...
            self.anthropicAuthStatus = "Connected. Espada can now use Claude."
        } catch {
